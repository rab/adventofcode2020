...
puts "Part 1:", boarding_passes.map(&:to_i).max
...
puts 'Part 2:', boarding_passes.map(&:to_i).sort.each_cons(2).detect {|a,b| a && b && (b - a) == 2 }.map{|a,b| a.succ }.first
